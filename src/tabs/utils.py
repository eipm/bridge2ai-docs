...
def create_html_table(csv_file_path, caption=None, cell_values=[], column_index=-1,link_formatter=None):
    # Read CSV file
    ...
    html_table = df.to_html(index=False, classes='table table-striped',escape=False,formatters=link_formatter)
