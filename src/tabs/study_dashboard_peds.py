...
from tabs.utils import load_peds_data
...
def study_dashboard_page_peds(tab_name):
    data = load_peds_data()
    if not data:
    ...
    disorder_plots = [
        ...
        ("snoring_and_obstructive_sleep_category", 'Snoring and Bbstructive Sleep Disorder', 'pie', {'height': 650, 'color_discrete_sequence': colors, 'y': -0.3, 'entry_width': 1, 'font_size': 11})
    ]
    # Data collec
